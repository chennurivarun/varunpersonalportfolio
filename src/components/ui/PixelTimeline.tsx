...
export const PixelTimeline = ({ items, className, pixelColor }: PixelTimelineProps) => {
  return (
    <div className={cn("relative", className)}>
      ...
      <div 
        ...
        style={{
          backgroundImage: "linear-gradient(to bottom, hsl(var(--pixel-color)) 50%, transparent 50%)",
      ...
      {items.map((item, index) => (
        ...
        >
          <div className="flex items-center md:w-1/2 z-10">
            <div 
              className={cn(
                "w-8 h-8 flex items-center justify-center bg-background border-2 border-pixel rounded-none",
            ...
            <div 
              className={cn(
                "flex-1 border-2 border-pixel p-4 ml-4 md:ml-0 md:mr-0",
            ...
            >
              <div className="absolute -bottom-1 -right-1 h-2 w-2 border-b-2 border-r-2 border-pixel"></div>
